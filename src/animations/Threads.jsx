...
const Threads = ({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      //   renderer.setSize(clientWidth / 1.2, clientHeight / 1.2);
      //   gl.canvas.style.width = clientWidth + "px";
      //   gl.canvas.style.height = clientHeight + "px";

      const dpr = Math.min(window.devicePixelRatio, 1.5); // cap high-DPI
      renderer.setSize(clientWidth * dpr, clientHeight * dpr, false);
      gl.canvas.style.width = clientWidth + "px"; // upscale in CSS
      gl.canvas.style.height = clientHeight + "px";

          ...
          <div className="w-full flex flex-col gap-4 mt-2">
            <div className="relative">
              <input
                ...
                className="w-full border-2 border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900/50 p-4 rounded-xl text-center tracking-[0.5em] text-2xl font-mono uppercase focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 transition-colors text-neutral-900 dark:text-white placeholder:text-neutral-600 dark:placeholder:text-neutral-400 placeholder:tracking-normal"
              />
            </div>
            <button
              onClick={joinRoom}

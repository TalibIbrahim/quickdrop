...
const LayoutWrapper = (props) => {
  ...
  return (
    <>
      <Navbar />
      <main className="bg-gradient-to-b from-white to-neutral-50 min-h-screen overflow-x-hidden dark:bg-none dark:min-h-screen dark:bg-neutral-950 transition-colors duration-300 ease-in-out">
        {props.children}
      </main>
      <Footer />
      <button
